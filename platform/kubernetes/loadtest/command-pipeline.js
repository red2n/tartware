...
const tenantIds = (__ENV.TENANT_IDS || "11111111-1111-1111-1111-111111111111")
	.split(",")
	.filter(Boolean);
const propertyIds = (__ENV.PROPERTY_IDS || "22222222-2222-2222-2222-222222222222")
	.split(",")
	.filter(Boolean);
const roomTypeIds = (__ENV.ROOM_TYPE_IDS || "44444444-4444-4444-4444-444444444444")
	.split(",")
	.filter(Boolean);
...
function generateReservation(tenantId, propertyId, roomTypeId) {
...
function pickTenant() {
	return pickRandom(tenantIds) || "11111111-1111-1111-1111-111111111111";
}

function pickProperty() {
	return pickRandom(propertyIds) || "22222222-2222-2222-2222-222222222222";
}

function pickRoomType() {
	return pickRandom(roomTypeIds) || "44444444-4444-4444-4444-444444444444";
}
