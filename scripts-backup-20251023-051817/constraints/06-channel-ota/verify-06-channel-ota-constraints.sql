...
BEGIN
    ...
    IF v_restrict_count = v_total_fks AND v_cascade_count = v_total_fks THEN
        RAISE NOTICE '✓✓✓ CHANNEL MANAGEMENT & OTA CONSTRAINT VERIFICATION PASSED ✓✓✓';
    ELSE
        RAISE WARNING '⚠⚠⚠ CHANNEL MANAGEMENT & OTA CONSTRAINT POLICY VIOLATIONS FOUND ⚠⚠⚠';
    END IF;
END $$;

\echo ''
\echo '=============================================='
\echo 'Channel Management & OTA constraint verification complete!'
\echo '=============================================='
