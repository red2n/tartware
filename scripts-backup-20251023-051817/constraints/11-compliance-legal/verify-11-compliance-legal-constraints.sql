-- =====================================================
-- verify-11-compliance-legal-constraints.sql
-- Constraint Verification Script for Compliance & Legal
...
\echo ''
\echo '=============================================='
\echo '  COMPLIANCE & LEGAL - CONSTRAINT VERIFICATION'
\echo '  Tables: 4'
\echo '=============================================='
\echo ''
...
BEGIN
    ...
    WHERE constraint_type = 'FOREIGN KEY'
        AND table_name IN ('gdpr_consent_logs', 'police_reports', 'contract_agreements', 'insurance_claims')
        AND tc.table_schema = 'public';
    ...
    IF v_restrict_count = v_total_fks AND v_cascade_count = v_total_fks THEN
        RAISE NOTICE '✓✓✓ COMPLIANCE & LEGAL CONSTRAINT VERIFICATION PASSED ✓✓✓';
    ELSE
        RAISE WARNING '⚠⚠⚠ COMPLIANCE & LEGAL CONSTRAINT POLICY VIOLATIONS FOUND ⚠⚠⚠';
    END IF;
END $$;

\echo ''
\echo '=============================================='
\echo 'Compliance & Legal constraint verification complete!'
\echo '=============================================='
