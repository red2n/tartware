-- =====================================================
-- verify-10-marketing-campaigns-constraints.sql
-- Constraint Verification Script for Marketing & Campaigns
...
\echo ''
\echo '=============================================='
\echo '  MARKETING & CAMPAIGNS - CONSTRAINT VERIFICATION'
\echo '  Tables: 5'
\echo '=============================================='
\echo ''
...
WHERE tc.constraint_type = 'FOREIGN KEY'
    AND tc.table_name IN ('marketing_campaigns', 'campaign_segments', 'promotional_codes', 'referral_tracking', 'social_media_mentions')
...
BEGIN
    ...
    WHERE constraint_type = 'FOREIGN KEY'
        AND table_name IN ('marketing_campaigns', 'campaign_segments', 'promotional_codes', 'referral_tracking', 'social_media_mentions')
        AND tc.table_schema = 'public';
    ...
    IF v_restrict_count = v_total_fks AND v_cascade_count = v_total_fks THEN
        RAISE NOTICE '✓✓✓ MARKETING & CAMPAIGNS CONSTRAINT VERIFICATION PASSED ✓✓✓';
    ELSE
        RAISE WARNING '⚠⚠⚠ MARKETING & CAMPAIGNS CONSTRAINT POLICY VIOLATIONS FOUND ⚠⚠⚠';
    END IF;
END $$;

\echo ''
\echo '=============================================='
\echo 'Marketing & Campaigns constraint verification complete!'
\echo '=============================================='
