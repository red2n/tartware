...
ALTER TABLE accounts_receivable
    ...
    FOREIGN KEY (collection_agent_id) REFERENCES users(id)
    ON DELETE SET NULL;
...
ALTER TABLE accounts_receivable
    ...
    FOREIGN KEY (write_off_approved_by) REFERENCES users(id)
    ON DELETE SET NULL;
...
ALTER TABLE accounts_receivable
    ...
    FOREIGN KEY (collection_manager_id) REFERENCES users(id)
    ON DELETE SET NULL;
