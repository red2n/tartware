...
ALTER TABLE guest_communications
    ADD CONSTRAINT IF NOT EXISTS fk_guest_comm_tenant
    FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE;

-- Foreign key to properties
ALTER TABLE guest_communications
    ADD CONSTRAINT IF NOT EXISTS fk_guest_comm_property
    FOREIGN KEY (property_id) REFERENCES properties(id) ON DELETE CASCADE;

-- Foreign key to guests
ALTER TABLE guest_communications
    ADD CONSTRAINT IF NOT EXISTS fk_guest_comm_guest
    FOREIGN KEY (guest_id) REFERENCES guests(id) ON DELETE CASCADE;

-- Foreign key to reservations (optional, set NULL if deleted)
ALTER TABLE guest_communications
    ADD CONSTRAINT IF NOT EXISTS fk_guest_comm_reservation
