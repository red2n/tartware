-- =====================================================
-- verify-07-guest-crm-constraints.sql
-- Constraint Verification Script for Guest Relations & CRM
...
\echo ''
\echo '=============================================='
\echo '  GUEST RELATIONS & CRM - CONSTRAINT VERIFICATION'
\echo '  Tables: 7'
\echo '=============================================='
\echo ''
...
\echo ''
\echo '=============================================='
\echo 'Guest Relations & CRM constraint verification complete!'
\echo '=============================================='
