...
ALTER TABLE ota_reservations_queue
    ADD CONSTRAINT IF NOT EXISTS fk_ota_queue_tenant
    FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE;

-- Foreign key to properties
ALTER TABLE ota_reservations_queue
    ADD CONSTRAINT IF NOT EXISTS fk_ota_queue_property
    FOREIGN KEY (property_id) REFERENCES properties(id) ON DELETE CASCADE;

-- Foreign key to ota_configurations
ALTER TABLE ota_reservations_queue
    ADD CONSTRAINT IF NOT EXISTS fk_ota_queue_ota_config
...
ALTER TABLE ota_reservations_queue
    ADD CONSTRAINT IF NOT EXISTS fk_ota_queue_reservation
