-- =====================================================
-- verify-10-marketing-campaigns-indexes.sql
-- Index Verification Script for Marketing & Campaigns
...
\echo ''
\echo '=============================================='
\echo '  MARKETING & CAMPAIGNS - INDEX VERIFICATION'
\echo '  Tables: 5'
\echo '=============================================='
\echo ''
...
FROM pg_indexes
WHERE tablename IN ('marketing_campaigns', 'campaign_segments', 'promotional_codes', 'referral_tracking', 'social_media_mentions')
...
BEGIN
    ...
    IF v_fk_without_index = 0 AND v_tables_with_indexes = 5 THEN
        RAISE NOTICE '✓✓✓ MARKETING & CAMPAIGNS INDEX VERIFICATION PASSED ✓✓✓';
    ELSE
        RAISE WARNING '⚠⚠⚠ MARKETING & CAMPAIGNS INDEX VERIFICATION ISSUES FOUND ⚠⚠⚠';
...
\echo ''
\echo '=============================================='
\echo 'Marketing & Campaigns index verification complete!'
\echo '=============================================='
