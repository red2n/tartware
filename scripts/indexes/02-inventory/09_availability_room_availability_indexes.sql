...
CREATE INDEX IF NOT EXISTS idx_avail_rate_plan_id ON availability.room_availability(rate_plan_id);
...
CREATE INDEX IF NOT EXISTS idx_avail_property_type_rate_date
    ON availability.room_availability(property_id, room_type_id, rate_plan_id, availability_date);

-- Date range queries (for calendar views)
CREATE INDEX IF NOT EXISTS idx_avail_property_date_range ON availability.room_availability(property_id, rate_plan_id, availability_date);
...
CREATE INDEX IF NOT EXISTS idx_avail_property_status_date ON availability.room_availability(property_id, rate_plan_id, status, availability_date);
...
CREATE INDEX IF NOT EXISTS idx_avail_property_available ON availability.room_availability(property_id, rate_plan_id, availability_date, available_rooms)
...
CREATE INDEX IF NOT EXISTS idx_avail_is_closed ON availability.room_availability(is_closed) WHERE is_closed = true;
...
CREATE INDEX IF NOT EXISTS idx_avail_channel_allocations_gin ON availability.room_availability USING GIN(channel_allocations);
...
CREATE INDEX IF NOT EXISTS idx_avail_calendar ON availability.room_availability(property_id, rate_plan_id, availability_date, status, available_rooms);

-- Index for low inventory alerts
CREATE INDEX IF NOT EXISTS idx_avail_low_inventory ON availability.room_availability(property_id, room_type_id, rate_plan_id, availability_date, available_rooms)
