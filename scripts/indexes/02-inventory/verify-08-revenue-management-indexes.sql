-- =====================================================
-- verify-08-revenue-management-indexes.sql
-- Index Verification Script for Revenue Management
...
\echo ''
\echo '=============================================='
\echo '  REVENUE MANAGEMENT - INDEX VERIFICATION'
\echo '  Tables: 7'
\echo '=============================================='
\echo ''
...
FROM pg_indexes
WHERE tablename IN ('rate_overrides', 'revenue_forecasts', 'competitor_rates', 'demand_calendar', 'pricing_rules', 'rate_recommendations', 'revenue_goals')
...
BEGIN
    ...
    IF v_fk_without_index = 0 AND v_tables_with_indexes = 7 THEN
        RAISE NOTICE '✓✓✓ REVENUE MANAGEMENT INDEX VERIFICATION PASSED ✓✓✓';
    ELSE
        RAISE WARNING '⚠⚠⚠ REVENUE MANAGEMENT INDEX VERIFICATION ISSUES FOUND ⚠⚠⚠';
...
\echo ''
\echo '=============================================='
\echo 'Revenue Management index verification complete!'
\echo '=============================================='
