-- =====================================================
-- verify-07-guest-crm-indexes.sql
-- Index Verification Script for Guest Relations & CRM
...
\echo ''
\echo '=============================================='
\echo '  GUEST RELATIONS & CRM - INDEX VERIFICATION'
\echo '  Tables: 7'
\echo '=============================================='
\echo ''
...
FROM pg_indexes
WHERE tablename IN ('guest_communications', 'communication_templates', 'guest_feedback', 'guest_loyalty_programs', 'guest_documents', 'guest_notes', 'automated_messages')
...
BEGIN
    ...
    IF v_fk_without_index = 0 AND v_tables_with_indexes = 7 THEN
        RAISE NOTICE '✓✓✓ GUEST RELATIONS & CRM INDEX VERIFICATION PASSED ✓✓✓';
    ELSE
        RAISE WARNING '⚠⚠⚠ GUEST RELATIONS & CRM INDEX VERIFICATION ISSUES FOUND ⚠⚠⚠';
...
\echo ''
\echo '=============================================='
\echo 'Guest Relations & CRM index verification complete!'
\echo '=============================================='
