...
CREATE INDEX idx_charge_postings_folio
    ON charge_postings(tenant_id, folio_id, posting_date DESC, transaction_type)
    WHERE deleted_at IS NULL;
...
CREATE INDEX idx_charge_postings_reservation
    ON charge_postings(tenant_id, reservation_id, posting_date DESC)
...
CREATE INDEX idx_charge_postings_business_date
    ON charge_postings(tenant_id, property_id, business_date, transaction_type)
    WHERE deleted_at IS NULL;
...
CREATE INDEX idx_charge_postings_posting_date
    ON charge_postings(tenant_id, property_id, posting_date, posting_type)
    WHERE deleted_at IS NULL;
...
CREATE INDEX idx_charge_postings_transaction_type
    ON charge_postings(tenant_id, property_id, transaction_type, posting_date DESC)
    WHERE deleted_at IS NULL;
...
CREATE INDEX idx_charge_postings_source
    ON charge_postings(tenant_id, property_id, source_system, posting_date DESC)
...
CREATE INDEX idx_charge_postings_reconciliation
    ON charge_postings(tenant_id, property_id, is_reconciled, posting_date)
    WHERE deleted_at IS NULL;
...
CREATE INDEX idx_charge_postings_voided
    ON charge_postings(tenant_id, property_id, is_voided, voided_at DESC)
...
CREATE INDEX idx_charge_postings_department
    ON charge_postings(tenant_id, property_id, department_code, posting_date DESC)
