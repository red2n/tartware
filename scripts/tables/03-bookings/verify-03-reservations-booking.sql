...
-- Category: 03-reservations-booking (12 tables)
-- Date: 2025-10-19
-- =====================================================
...
\echo '  Tables: 12 | Description: Reservation lifecycle, deposits, allotments, waitlists'
\echo '=============================================='
\echo ''
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '✓✓✓ All 12 Reservations & Booking tables exist!';
    END IF;
END $$;
