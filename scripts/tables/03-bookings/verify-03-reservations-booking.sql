...
-- Category: 03-reservations-booking (11 tables)
-- Date: 2025-10-19
-- =====================================================
...
\echo '  Tables: 11 | Description: Reservation lifecycle, deposits, allotments, waitlists'
\echo '=============================================='
\echo ''
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '✓✓✓ All 11 Reservations & Booking tables exist!';
    END IF;
END $$;
