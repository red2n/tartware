...
-- Category: 07-guest-crm (12 tables)
-- Date: 2025-10-19
-- Updated: 2026-05-06
-- =====================================================
...
\echo '  Tables: 12 | Description: Communications, loyalty, rewards, documents, feedback'
\echo '=============================================='
\echo ''
...
DO $$
DECLARE
    v_expected_tables TEXT[] := ARRAY['guest_communications', 'communication_templates', 'guest_feedback', 'guest_loyalty_programs', 'guest_documents', 'guest_notes', 'automated_messages', 'reward_catalog', 'reward_redemptions', 'loyalty_point_transactions', 'loyalty_program_economics', 'loyalty_tier_rules'];
    v_table TEXT;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '✓✓✓ All 12 Guest Relations & CRM tables exist!';
    END IF;
END $$;
...
WHERE t.table_name IN ('guest_communications', 'communication_templates', 'guest_feedback', 'guest_loyalty_programs', 'guest_documents', 'guest_notes', 'automated_messages', 'reward_catalog', 'reward_redemptions', 'loyalty_point_transactions', 'loyalty_program_economics', 'loyalty_tier_rules')
