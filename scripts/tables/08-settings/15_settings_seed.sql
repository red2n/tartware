...
JOIN (VALUES
  ...
  ('ADMIN_USER_MANAGEMENT','password_policy',  'admin.password_min_length',       'Minimum Password Length',    'Minimum characters for staff passwords. PCI DSS 4.0 (8.3.6) requires 12.', 'INTEGER','NUMBER_INPUT','12',    ARRAY['TENANT'],'TENANT',TRUE, 'INTERNAL',10),
