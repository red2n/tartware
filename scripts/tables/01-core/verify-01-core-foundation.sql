...
-- Category: 01-core-foundation (15 tables)
-- Date: 2025-10-19
-- =====================================================
...
\echo '  Tables: 15 | Description: Multi-tenancy, users, properties, guest management, settings catalogue, reliability guardrails'
\echo '=============================================='
\echo ''
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '✓✓✓ All 15 Core Foundation tables exist!';
    END IF;
END $$;
