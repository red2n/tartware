...
WITH seed_commands(command_name, description, default_target_service, required_modules) AS (
    VALUES
        ...
        ('billing.ar.post', 'Post an outstanding folio balance to accounts receivable', 'billing-service', ARRAY['finance-automation']),
        ('billing.ar.apply_payment', 'Apply a payment against an accounts receivable balance', 'billing-service', ARRAY['finance-automation']),
        ('billing.ar.age', 'Recalculate aging buckets for accounts receivable entries', 'billing-service', ARRAY['finance-automation']),
        ('billing.ar.write_off', 'Write off an uncollectible accounts receivable entry', 'billing-service', ARRAY['finance-automation']),
        ('billing.tax_config.create', 'Create a new tax configuration entry', 'billing-service', ARRAY['finance-automation']),
        ('billing.tax_config.update', 'Update an existing tax configuration entry', 'billing-service', ARRAY['finance-automation']),
        ('billing.tax_config.delete', 'Soft-delete a tax configuration entry', 'billing-service', ARRAY['finance-automation']),
        ...
        ('billing.pricing.evaluate', 'Evaluate dynamic pricing rules for a room type', 'billing-service', ARRAY['finance-automation']),
        ('billing.pricing.bulk_recommend', 'Bulk generate pricing recommendations', 'billing-service', ARRAY['finance-automation']),
        ('billing.fiscal_period.close', 'Close a fiscal period to prevent new postings', 'billing-service', ARRAY['finance-automation']),
        ('billing.fiscal_period.lock', 'Lock a closed fiscal period against all changes', 'billing-service', ARRAY['finance-automation']),
        ('billing.fiscal_period.reopen', 'Reopen a closed fiscal period for adjustments', 'billing-service', ARRAY['finance-automation']),
        ('billing.folio_window.create', 'Create a date-based folio window for split billing', 'billing-service', ARRAY['finance-automation']),
        ('commission.calculate', 'Calculate and record commission for a reservation', 'billing-service', ARRAY['finance-automation']),
        ('commission.approve', 'Approve a pending commission for payout', 'billing-service', ARRAY['finance-automation']),
        ('commission.mark_paid', 'Mark a commission as paid out', 'billing-service', ARRAY['finance-automation']),
        ('commission.statement.generate', 'Generate a commission statement for an agent or period', 'billing-service', ARRAY['finance-automation']),
