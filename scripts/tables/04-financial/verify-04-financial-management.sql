...
-- Category: 04-financial-management (19 tables)
-- Date: 2025-10-19
-- Updated: 2026-03-12
-- =====================================================
...
\echo '  Tables: 19 | Description: Payments, invoices, accounting, receivables, GL exports, comp accounting, fiscal periods'
\echo '=============================================='
\echo ''
...
DO $$
DECLARE
    v_expected_tables TEXT[] := ARRAY['payments', 'invoices', 'invoice_items', 'folios', 'charge_postings', 'refunds', 'tax_configurations', 'financial_closures', 'commission_tracking', 'cashier_sessions', 'accounts_receivable', 'credit_limits', 'payment_tokens', 'general_ledger_batches', 'general_ledger_entries', 'comp_authorizers', 'comp_transactions', 'comp_property_config', 'fiscal_periods'];
    v_table TEXT;
...
BEGIN
    ...
    ELSE
        RAISE NOTICE '✓✓✓ All 19 Financial Management tables exist!';
    END IF;
END $$;
