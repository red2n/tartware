...
\echo '  - ENUM Types: 60+'
\echo '  - Tables: 134 (133 in public, 1 in availability)'
\echo '  - Row Counts: 100+ (reference data system defaults)'
\echo ''
\echo 'Table Breakdown:'
\echo '  - 7 business domains (core → analytics)'
\echo '  - 1 settings catalog domain'
\echo '  - 1 reference data domain (dynamic enums)'
\echo '  - Total: 134 Tables'
\echo ''
\echo 'Next Steps:'
