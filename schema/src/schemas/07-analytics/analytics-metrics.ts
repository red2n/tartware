...
import { MetricTypeEnum, TimeGranularityEnum, AnalyticsStatusEnum } from '../../shared/enums.js';
...
export type CreateAnalyticsMetrics = z.infer<typeof CreateAnalyticsMetricsSchema>;
...
export type UpdateAnalyticsMetrics = z.infer<typeof UpdateAnalyticsMetricsSchema>;
