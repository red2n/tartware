...
export type CreatePerformanceReports = z.infer<typeof CreatePerformanceReportsSchema>;

/**
 * Schema for updating a performance reports
 */
export const UpdatePerformanceReportsSchema = PerformanceReportsSchema.partial();

export type UpdatePerformanceReports = z.infer<typeof UpdatePerformanceReportsSchema>;
