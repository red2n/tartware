...
export type CreateAnalyticsReports = z.infer<
	typeof CreateAnalyticsReportsSchema
>;
...
export type UpdateAnalyticsReports = z.infer<
	typeof UpdateAnalyticsReportsSchema
>;
