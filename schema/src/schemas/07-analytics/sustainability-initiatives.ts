 ...
 */
export const CreateSustainabilityInitiativesSchema = SustainabilityInitiativesSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateSustainabilityInitiatives = z.infer<typeof CreateSustainabilityInitiativesSchema>;

/**
 * Schema for updating a sustainability initiatives
 */
export const UpdateSustainabilityInitiativesSchema = SustainabilityInitiativesSchema.partial();

export type UpdateSustainabilityInitiatives = z.infer<typeof UpdateSustainabilityInitiativesSchema>;
