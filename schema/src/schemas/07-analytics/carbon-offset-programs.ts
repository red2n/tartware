...
export type CreateCarbonOffsetPrograms = z.infer<typeof CreateCarbonOffsetProgramsSchema>;

/**
 * Schema for updating a carbon offset programs
 */
export const UpdateCarbonOffsetProgramsSchema = CarbonOffsetProgramsSchema.partial();

export type UpdateCarbonOffsetPrograms = z.infer<typeof UpdateCarbonOffsetProgramsSchema>;
