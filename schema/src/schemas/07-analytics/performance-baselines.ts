...
export type CreatePerformanceBaselines = z.infer<
	typeof CreatePerformanceBaselinesSchema
>;

/**
 * Schema for updating a performance baselines
 */
export const UpdatePerformanceBaselinesSchema =
	PerformanceBaselinesSchema.partial();

export type UpdatePerformanceBaselines = z.infer<
	typeof UpdatePerformanceBaselinesSchema
>;
