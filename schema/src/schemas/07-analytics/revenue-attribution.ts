...
export type CreateRevenueAttribution = z.infer<typeof CreateRevenueAttributionSchema>;

/**
 * Schema for updating a revenue attribution
 */
export const UpdateRevenueAttributionSchema = RevenueAttributionSchema.partial();

export type UpdateRevenueAttribution = z.infer<typeof UpdateRevenueAttributionSchema>;
