...
export type CreateGuestJourneyTracking = z.infer<typeof CreateGuestJourneyTrackingSchema>;

/**
 * Schema for updating a guest journey tracking
 */
export const UpdateGuestJourneyTrackingSchema = GuestJourneyTrackingSchema.partial();

export type UpdateGuestJourneyTracking = z.infer<typeof UpdateGuestJourneyTrackingSchema>;
