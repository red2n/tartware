...
export type CreateReportPropertyIds = z.infer<
	typeof CreateReportPropertyIdsSchema
>;
...
export type UpdateReportPropertyIds = z.infer<
	typeof UpdateReportPropertyIdsSchema
>;
