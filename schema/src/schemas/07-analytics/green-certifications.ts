...
export type CreateGreenCertifications = z.infer<typeof CreateGreenCertificationsSchema>;

/**
 * Schema for updating a green certifications
 */
export const UpdateGreenCertificationsSchema = GreenCertificationsSchema.partial();

export type UpdateGreenCertifications = z.infer<typeof UpdateGreenCertificationsSchema>;
