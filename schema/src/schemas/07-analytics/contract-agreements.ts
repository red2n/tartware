...
export type CreateContractAgreements = z.infer<typeof CreateContractAgreementsSchema>;

/**
 * Schema for updating a contract agreements
 */
export const UpdateContractAgreementsSchema = ContractAgreementsSchema.partial();

export type UpdateContractAgreements = z.infer<typeof UpdateContractAgreementsSchema>;
