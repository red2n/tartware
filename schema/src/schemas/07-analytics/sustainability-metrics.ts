 ...
 */
export const CreateSustainabilityMetricsSchema = SustainabilityMetricsSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateSustainabilityMetrics = z.infer<typeof CreateSustainabilityMetricsSchema>;

/**
 * Schema for updating a sustainability metrics
 */
export const UpdateSustainabilityMetricsSchema = SustainabilityMetricsSchema.partial();

export type UpdateSustainabilityMetrics = z.infer<typeof UpdateSustainabilityMetricsSchema>;
