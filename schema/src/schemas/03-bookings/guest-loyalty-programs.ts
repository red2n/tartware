...
export type CreateGuestLoyaltyPrograms = z.infer<
	typeof CreateGuestLoyaltyProgramsSchema
>;

/**
 * Schema for updating a guest loyalty programs
 */
export const UpdateGuestLoyaltyProgramsSchema =
	GuestLoyaltyProgramsSchema.partial();

export type UpdateGuestLoyaltyPrograms = z.infer<
	typeof UpdateGuestLoyaltyProgramsSchema
>;
