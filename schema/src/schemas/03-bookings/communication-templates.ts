...
export type CommunicationTemplates = z.infer<typeof CommunicationTemplatesSchema>;

/**
 * Schema for creating a new communication templates
 */
export const CreateCommunicationTemplatesSchema = CommunicationTemplatesSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateCommunicationTemplates = z.infer<typeof CreateCommunicationTemplatesSchema>;

/**
 * Schema for updating a communication templates
 */
export const UpdateCommunicationTemplatesSchema = CommunicationTemplatesSchema.partial();

export type UpdateCommunicationTemplates = z.infer<typeof UpdateCommunicationTemplatesSchema>;
