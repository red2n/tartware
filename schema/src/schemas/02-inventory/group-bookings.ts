...
export const GroupBookingsSchema = z.object({
  ...
  negotiated_rate: money.optional(),
  ...
  shuttle_service_required: z.boolean().optional(),
  ...
  actual_room_revenue: money.optional(),
  actual_fb_revenue: money.optional(),
  actual_meeting_revenue: money.optional(),
  ...
  cancellation_fee_currency: z.string().optional(),
