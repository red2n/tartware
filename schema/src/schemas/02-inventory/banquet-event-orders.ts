...
export type CreateBanquetEventOrders = z.infer<
	typeof CreateBanquetEventOrdersSchema
>;

/**
 * Schema for updating a banquet event orders
 */
export const UpdateBanquetEventOrdersSchema =
	BanquetEventOrdersSchema.partial();

export type UpdateBanquetEventOrders = z.infer<
	typeof UpdateBanquetEventOrdersSchema
>;
