...
export const DemandCalendarSchema = z.object({
	...
	expected_precipitation_mm: money.optional(),
	expected_high_temperature_celsius: money.optional(),
	expected_low_temperature_celsius: money.optional(),
	actual_precipitation_mm: money.optional(),
	actual_high_temperature_celsius: money.optional(),
	actual_low_temperature_celsius: money.optional(),
