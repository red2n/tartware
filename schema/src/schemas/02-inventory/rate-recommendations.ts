...
export type CreateRateRecommendations = z.infer<
	typeof CreateRateRecommendationsSchema
>;

/**
 * Schema for updating a rate recommendations
 */
export const UpdateRateRecommendationsSchema =
	RateRecommendationsSchema.partial();

export type UpdateRateRecommendations = z.infer<
	typeof UpdateRateRecommendationsSchema
>;
