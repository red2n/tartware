...
export type CreateRevenueForecasts = z.infer<
	typeof CreateRevenueForecastsSchema
>;
...
export type UpdateRevenueForecasts = z.infer<
	typeof UpdateRevenueForecastsSchema
>;
