...
export const RevenueGoalsSchema = z.object({
  ...
  baseline_date: z.coerce.date().optional(),
  growth_target_amount: money.optional(),
  ...
  rooms_sold_goal: z.number().int().optional(),
  ...
  daily_tracking: z.record(z.unknown()).optional(),
  ...
  alert_if_behind_by_amount: money.optional(),
  ...
  incentive_paid_at: z.coerce.date().optional(),
