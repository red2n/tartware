...
export type CreateCommissionStatements = z.infer<
	typeof CreateCommissionStatementsSchema
>;

/**
 * Schema for updating a commission statements
 */
export const UpdateCommissionStatementsSchema =
	CommissionStatementsSchema.partial();

export type UpdateCommissionStatements = z.infer<
	typeof UpdateCommissionStatementsSchema
>;
