...
export type CreateCommissionTracking = z.infer<
	typeof CreateCommissionTrackingSchema
>;

/**
 * Schema for updating a commission tracking
 */
export const UpdateCommissionTrackingSchema =
	CommissionTrackingSchema.partial();

export type UpdateCommissionTracking = z.infer<
	typeof UpdateCommissionTrackingSchema
>;
