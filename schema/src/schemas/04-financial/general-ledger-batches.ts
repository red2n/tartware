...
export type CreateGeneralLedgerBatches = z.infer<typeof CreateGeneralLedgerBatchesSchema>;

/**
 * Schema for updating a general ledger batches
 */
export const UpdateGeneralLedgerBatchesSchema = GeneralLedgerBatchesSchema.partial();

export type UpdateGeneralLedgerBatches = z.infer<typeof UpdateGeneralLedgerBatchesSchema>;
