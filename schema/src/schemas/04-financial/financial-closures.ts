...
export type CreateFinancialClosures = z.infer<typeof CreateFinancialClosuresSchema>;
...
export type UpdateFinancialClosures = z.infer<typeof UpdateFinancialClosuresSchema>;
