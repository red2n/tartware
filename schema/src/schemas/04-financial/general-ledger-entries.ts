...
export type CreateGeneralLedgerEntries = z.infer<typeof CreateGeneralLedgerEntriesSchema>;

/**
 * Schema for updating a general ledger entries
 */
export const UpdateGeneralLedgerEntriesSchema = GeneralLedgerEntriesSchema.partial();

export type UpdateGeneralLedgerEntries = z.infer<typeof UpdateGeneralLedgerEntriesSchema>;
