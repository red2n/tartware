...
export const GuestSchema = z.object({
  ...
  title: z.enum(['Mr', 'Mrs', 'Ms', 'Miss', 'Dr', 'Prof']).optional().describe('Title/salutation'),
  date_of_birth: z.coerce.date().optional().describe('Date of birth'),
  gender: z.enum(['Male', 'Female', 'Other', 'Prefer not to say']).optional().describe('Gender'),
  ...
  communication_preferences: CommunicationPreferencesSchema.describe('Communication preferences'),
