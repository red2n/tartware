...
export type CreateGuestRoomPreferences = z.infer<typeof CreateGuestRoomPreferencesSchema>;

/**
 * Schema for updating a guest room preferences
 */
export const UpdateGuestRoomPreferencesSchema = GuestRoomPreferencesSchema.partial();

export type UpdateGuestRoomPreferences = z.infer<typeof UpdateGuestRoomPreferencesSchema>;
