...
export type CreateMaintenanceRequests = z.infer<typeof CreateMaintenanceRequestsSchema>;

/**
 * Schema for updating a maintenance requests
 */
export const UpdateMaintenanceRequestsSchema = MaintenanceRequestsSchema.partial();

export type UpdateMaintenanceRequests = z.infer<typeof UpdateMaintenanceRequestsSchema>;
