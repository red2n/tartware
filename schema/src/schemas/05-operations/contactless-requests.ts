...
export type CreateContactlessRequests = z.infer<
	typeof CreateContactlessRequestsSchema
>;

/**
 * Schema for updating a contactless requests
 */
export const UpdateContactlessRequestsSchema =
	ContactlessRequestsSchema.partial();

export type UpdateContactlessRequests = z.infer<
	typeof UpdateContactlessRequestsSchema
>;
