...
export type CreateMaintenanceHistory = z.infer<typeof CreateMaintenanceHistorySchema>;

/**
 * Schema for updating a maintenance history
 */
export const UpdateMaintenanceHistorySchema = MaintenanceHistorySchema.partial();

export type UpdateMaintenanceHistory = z.infer<typeof UpdateMaintenanceHistorySchema>;
