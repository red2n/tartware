...
export type CreateReservationServices = z.infer<typeof CreateReservationServicesSchema>;

/**
 * Schema for updating a reservation services
 */
export const UpdateReservationServicesSchema = ReservationServicesSchema.partial();

export type UpdateReservationServices = z.infer<typeof UpdateReservationServicesSchema>;
