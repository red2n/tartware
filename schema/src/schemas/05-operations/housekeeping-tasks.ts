...
export type CreateHousekeepingTasks = z.infer<
	typeof CreateHousekeepingTasksSchema
>;
...
export type UpdateHousekeepingTasks = z.infer<
	typeof UpdateHousekeepingTasksSchema
>;
