...
export type DigitalRegistrationCards = z.infer<
	typeof DigitalRegistrationCardsSchema
>;

/**
 * Schema for creating a new digital registration cards
 */
export const CreateDigitalRegistrationCardsSchema =
	DigitalRegistrationCardsSchema.omit({
		// TODO: Add fields to omit for creation
	});

export type CreateDigitalRegistrationCards = z.infer<
	typeof CreateDigitalRegistrationCardsSchema
>;

/**
 * Schema for updating a digital registration cards
 */
export const UpdateDigitalRegistrationCardsSchema =
	DigitalRegistrationCardsSchema.partial();

export type UpdateDigitalRegistrationCards = z.infer<
	typeof UpdateDigitalRegistrationCardsSchema
>;
