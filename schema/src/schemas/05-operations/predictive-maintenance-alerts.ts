...
export type PredictiveMaintenanceAlerts = z.infer<typeof PredictiveMaintenanceAlertsSchema>;

/**
 * Schema for creating a new predictive maintenance alerts
 */
export const CreatePredictiveMaintenanceAlertsSchema = PredictiveMaintenanceAlertsSchema.omit({
 ...
 */
export const UpdatePredictiveMaintenanceAlertsSchema = PredictiveMaintenanceAlertsSchema.partial();
