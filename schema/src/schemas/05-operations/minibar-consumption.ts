...
export type CreateMinibarConsumption = z.infer<typeof CreateMinibarConsumptionSchema>;

/**
 * Schema for updating a minibar consumption
 */
export const UpdateMinibarConsumptionSchema = MinibarConsumptionSchema.partial();

export type UpdateMinibarConsumption = z.infer<typeof UpdateMinibarConsumptionSchema>;
