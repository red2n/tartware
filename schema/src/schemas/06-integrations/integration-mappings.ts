...
export type CreateIntegrationMappings = z.infer<typeof CreateIntegrationMappingsSchema>;

/**
 * Schema for updating a integration mappings
 */
export const UpdateIntegrationMappingsSchema = IntegrationMappingsSchema.partial();

export type UpdateIntegrationMappings = z.infer<typeof UpdateIntegrationMappingsSchema>;
