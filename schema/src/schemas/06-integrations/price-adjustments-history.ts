...
export type PriceAdjustmentsHistory = z.infer<typeof PriceAdjustmentsHistorySchema>;

/**
 * Schema for creating a new price adjustments history
 */
export const CreatePriceAdjustmentsHistorySchema = PriceAdjustmentsHistorySchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreatePriceAdjustmentsHistory = z.infer<typeof CreatePriceAdjustmentsHistorySchema>;

/**
 * Schema for updating a price adjustments history
 */
export const UpdatePriceAdjustmentsHistorySchema = PriceAdjustmentsHistorySchema.partial();

export type UpdatePriceAdjustmentsHistory = z.infer<typeof UpdatePriceAdjustmentsHistorySchema>;
