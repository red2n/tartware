...
export type CreateOtaReservationsQueue = z.infer<typeof CreateOtaReservationsQueueSchema>;

/**
 * Schema for updating a ota reservations queue
 */
export const UpdateOtaReservationsQueueSchema = OtaReservationsQueueSchema.partial();

export type UpdateOtaReservationsQueue = z.infer<typeof UpdateOtaReservationsQueueSchema>;
