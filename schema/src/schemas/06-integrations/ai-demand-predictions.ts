...
export type CreateAiDemandPredictions = z.infer<
	typeof CreateAiDemandPredictionsSchema
>;

/**
 * Schema for updating a ai demand predictions
 */
export const UpdateAiDemandPredictionsSchema =
	AiDemandPredictionsSchema.partial();

export type UpdateAiDemandPredictions = z.infer<
	typeof UpdateAiDemandPredictionsSchema
>;
