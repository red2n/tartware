...
export type CreateGdsReservationQueue = z.infer<
	typeof CreateGdsReservationQueueSchema
>;

/**
 * Schema for updating a gds reservation queue
 */
export const UpdateGdsReservationQueueSchema =
	GdsReservationQueueSchema.partial();

export type UpdateGdsReservationQueue = z.infer<
	typeof UpdateGdsReservationQueueSchema
>;
