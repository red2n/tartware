...
export type CreateMarketingCampaigns = z.infer<typeof CreateMarketingCampaignsSchema>;

/**
 * Schema for updating a marketing campaigns
 */
export const UpdateMarketingCampaignsSchema = MarketingCampaignsSchema.partial();

export type UpdateMarketingCampaigns = z.infer<typeof UpdateMarketingCampaignsSchema>;
