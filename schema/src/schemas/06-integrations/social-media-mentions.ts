...
export type CreateSocialMediaMentions = z.infer<typeof CreateSocialMediaMentionsSchema>;

/**
 * Schema for updating a social media mentions
 */
export const UpdateSocialMediaMentionsSchema = SocialMediaMentionsSchema.partial();

export type UpdateSocialMediaMentions = z.infer<typeof UpdateSocialMediaMentionsSchema>;
