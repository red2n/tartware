 ...
 */
export const CreateGuestBehaviorPatternsSchema = GuestBehaviorPatternsSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateGuestBehaviorPatterns = z.infer<typeof CreateGuestBehaviorPatternsSchema>;

/**
 * Schema for updating a guest behavior patterns
 */
export const UpdateGuestBehaviorPatternsSchema = GuestBehaviorPatternsSchema.partial();

export type UpdateGuestBehaviorPatterns = z.infer<typeof UpdateGuestBehaviorPatternsSchema>;
