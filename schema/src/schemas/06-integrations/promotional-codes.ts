...
export type CreatePromotionalCodes = z.infer<
	typeof CreatePromotionalCodesSchema
>;
...
export type UpdatePromotionalCodes = z.infer<
	typeof UpdatePromotionalCodesSchema
>;
