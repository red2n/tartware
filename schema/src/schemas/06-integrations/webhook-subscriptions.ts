...
export type CreateWebhookSubscriptions = z.infer<typeof CreateWebhookSubscriptionsSchema>;

/**
 * Schema for updating a webhook subscriptions
 */
export const UpdateWebhookSubscriptionsSchema = WebhookSubscriptionsSchema.partial();

export type UpdateWebhookSubscriptions = z.infer<typeof UpdateWebhookSubscriptionsSchema>;
