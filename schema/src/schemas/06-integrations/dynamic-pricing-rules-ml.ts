 ...
 */
export const CreateDynamicPricingRulesMlSchema = DynamicPricingRulesMlSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateDynamicPricingRulesMl = z.infer<typeof CreateDynamicPricingRulesMlSchema>;

/**
 * Schema for updating a dynamic pricing rules ml
 */
export const UpdateDynamicPricingRulesMlSchema = DynamicPricingRulesMlSchema.partial();

export type UpdateDynamicPricingRulesMl = z.infer<typeof UpdateDynamicPricingRulesMlSchema>;
