...
export type CreateCampaignSegments = z.infer<
	typeof CreateCampaignSegmentsSchema
>;
...
export type UpdateCampaignSegments = z.infer<
	typeof UpdateCampaignSegmentsSchema
>;
