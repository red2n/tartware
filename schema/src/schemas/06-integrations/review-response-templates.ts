...
export type ReviewResponseTemplates = z.infer<typeof ReviewResponseTemplatesSchema>;

/**
 * Schema for creating a new review response templates
 */
export const CreateReviewResponseTemplatesSchema = ReviewResponseTemplatesSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateReviewResponseTemplates = z.infer<typeof CreateReviewResponseTemplatesSchema>;

/**
 * Schema for updating a review response templates
 */
export const UpdateReviewResponseTemplatesSchema = ReviewResponseTemplatesSchema.partial();

export type UpdateReviewResponseTemplates = z.infer<typeof UpdateReviewResponseTemplatesSchema>;
