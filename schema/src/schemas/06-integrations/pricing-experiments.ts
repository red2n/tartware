...
export type CreatePricingExperiments = z.infer<typeof CreatePricingExperimentsSchema>;

/**
 * Schema for updating a pricing experiments
 */
export const UpdatePricingExperimentsSchema = PricingExperimentsSchema.partial();

export type UpdatePricingExperiments = z.infer<typeof UpdatePricingExperimentsSchema>;
