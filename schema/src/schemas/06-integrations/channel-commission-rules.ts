...
export type ChannelCommissionRules = z.infer<typeof ChannelCommissionRulesSchema>;

/**
 * Schema for creating a new channel commission rules
 */
export const CreateChannelCommissionRulesSchema = ChannelCommissionRulesSchema.omit({
  // TODO: Add fields to omit for creation
});

export type CreateChannelCommissionRules = z.infer<typeof CreateChannelCommissionRulesSchema>;

/**
 * Schema for updating a channel commission rules
 */
export const UpdateChannelCommissionRulesSchema = ChannelCommissionRulesSchema.partial();

export type UpdateChannelCommissionRules = z.infer<typeof UpdateChannelCommissionRulesSchema>;
