 ...
 */
export const CreatePersonalizedRecommendationsSchema = PersonalizedRecommendationsSchema.omit({
 ...
 */
export const UpdatePersonalizedRecommendationsSchema = PersonalizedRecommendationsSchema.partial();
