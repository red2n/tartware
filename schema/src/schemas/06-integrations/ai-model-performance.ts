...
export type CreateAiModelPerformance = z.infer<typeof CreateAiModelPerformanceSchema>;

/**
 * Schema for updating a ai model performance
 */
export const UpdateAiModelPerformanceSchema = AiModelPerformanceSchema.partial();

export type UpdateAiModelPerformance = z.infer<typeof UpdateAiModelPerformanceSchema>;
