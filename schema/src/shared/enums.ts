 ...
 */
export const TenantTypeEnum = z.enum(['INDEPENDENT', 'CHAIN', 'FRANCHISE', 'MANAGEMENT_COMPANY']);
 ...
 */
export const TenantStatusEnum = z.enum(['TRIAL', 'ACTIVE', 'SUSPENDED', 'INACTIVE', 'CANCELLED']);
 ...
 */
export const TenantRoleEnum = z.enum(['OWNER', 'ADMIN', 'MANAGER', 'STAFF', 'VIEWER']);
 ...
 */
export const RateStatusEnum = z.enum(['ACTIVE', 'INACTIVE', 'EXPIRED', 'FUTURE']);
 ...
 */
export const SeasonTypeEnum = z.enum(['LOW', 'SHOULDER', 'HIGH', 'PEAK', 'SPECIAL_EVENT']);
 ...
 */
export const ScenarioTypeEnum = z.enum(['BEST_CASE', 'WORST_CASE', 'MOST_LIKELY', 'CUSTOM']);
 ...
 */
export const MeasurementPeriodEnum = z.enum(['DAILY', 'WEEKLY', 'MONTHLY', 'QUARTERLY', 'YEARLY']);
...
export type RegulatoryComplianceStatus = z.infer<typeof RegulatoryComplianceStatusEnum>;
...
export type CarbonOffsetProgramType = z.infer<typeof CarbonOffsetProgramTypeEnum>;
...
export type SustainabilityInitiativeCategory = z.infer<typeof SustainabilityInitiativeCategoryEnum>;
 ...
 */
export const OperationalStatusEnum = z.enum(['NORMAL', 'WARNING', 'ERROR', 'CRITICAL']);
 ...
 */
export const EfficiencyRatingEnum = z.enum(['EXCELLENT', 'GOOD', 'AVERAGE', 'POOR', 'VERY_POOR']);
 ...
 */
export const EventSeverityEnum = z.enum(['INFO', 'WARNING', 'ERROR', 'CRITICAL']);
 ...
 */
export const CriticalityLevelEnum = z.enum(['LOW', 'MEDIUM', 'HIGH', 'CRITICAL']);
 ...
 */
export const AlertSeverityEnum = z.enum(['INFO', 'LOW', 'MEDIUM', 'HIGH', 'CRITICAL']);
 ...
 */
export const PredictionAccuracyEnum = z.enum(['ACCURATE', 'EARLY', 'LATE', 'FALSE_POSITIVE']);
