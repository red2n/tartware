...
export type ReservationStatusSummary = z.infer<
	typeof ReservationStatusSummarySchema
>;
...
export type ReservationSourceSummary = z.infer<
	typeof ReservationSourceSummarySchema
>;
