...
/**
 * Fields a caller may set on a company.
 *
 * `company_id` is generated by the table; `current_balance` and the booking
 * statistics are derived by other flows and are not settable here. The subset is
 * deliberately the contract-and-contact information a person types when opening
 * an account — the rest of this wide table is machine-maintained.
 */
