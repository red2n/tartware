...
import { registerEnterpriseInsightsRoutes } from "./routes/enterprise-insights.js";
...
import { registerPortalExperienceRoutes } from "./routes/portal-experience.js";
...
export const buildServer = (): FastifyInstance => {
  ...
  app.after(() => {
    ...
    registerPortalExperienceRoutes(app);
    registerEnterpriseInsightsRoutes(app);
