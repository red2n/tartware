...
const commandOutcomeCounter = new Counter({
  name: "revenue_command_outcomes_total",
  help: "Count of revenue commands processed by outcome",
  labelNames: ["command", "status"] as const,
  registers: [metricsRegistry],
});

const commandDurationHistogram = new Histogram({
  name: "revenue_command_processing_duration_seconds",
  help: "Duration of revenue command processing",
...
const commandConsumerLagGauge = new Gauge({
  name: "revenue_command_consumer_lag",
