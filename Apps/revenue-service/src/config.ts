...
const commandCenter = {
  ...
  consumerGroupId: process.env.COMMAND_CENTER_CONSUMER_GROUP ?? "revenue-command-center-consumer",
  targetServiceId: process.env.COMMAND_CENTER_TARGET_SERVICE_ID ?? "revenue-service",
...
export const config = {
  ...
  port: toNumber(process.env.PORT, 3060),
