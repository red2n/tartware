...
export const serviceTargets = {
  ...
  recommendationServiceUrl: env.RECOMMENDATION_SERVICE_URL ?? "http://localhost:3015",
  notificationServiceUrl: env.NOTIFICATION_SERVICE_URL ?? "http://localhost:3010",
  revenueServiceUrl: env.REVENUE_SERVICE_URL ?? "http://localhost:3090",
  guestExperienceServiceUrl: env.GUEST_EXPERIENCE_SERVICE_URL ?? "http://localhost:3010",
  calculationServiceUrl: env.CALCULATION_SERVICE_URL ?? "http://localhost:3015",
  serviceRegistryUrl: env.SERVICE_REGISTRY_URL ?? "http://localhost:3035",
  cashierServiceUrl: env.CASHIER_SERVICE_URL ?? "http://localhost:3025",
  accountsServiceUrl: env.ACCOUNTS_SERVICE_URL ?? "http://localhost:3090",
