...
process.env.SERVICE_NAME = process.env.SERVICE_NAME ?? "@tartware/cashier-service";
...
const commandCenter = {
  ...
  consumerGroupId: process.env.COMMAND_CENTER_CONSUMER_GROUP ?? "cashier-command-center-consumer",
  targetServiceId: process.env.COMMAND_CENTER_TARGET_SERVICE_ID ?? "cashier-service",
