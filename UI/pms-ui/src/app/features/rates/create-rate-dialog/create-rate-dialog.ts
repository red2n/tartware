...
export class CreateRateDialogComponent {
  ...
  get validationErrors(): Record<string, string> {
    ...
    if (this.singleOccupancyRate != null && this.baseRate != null && this.singleOccupancyRate > this.baseRate) {
      errors['sglRate'] = 'Single occupancy cannot exceed base rate';
    }

    if (this.doubleOccupancyRate != null && this.baseRate != null && this.doubleOccupancyRate > this.baseRate * 2) {
